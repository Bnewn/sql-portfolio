...
[View original case study →](https://8weeksqlchallenge.com/case-study-2/)
...
- `customer_orders` - Pizza orders with customizations and timestamps
- `runner_orders` - Delivery assignments with pickup times and distances
- `pizza_names` - Pizza type reference
- `pizza_recipes` - Standard toppings for each pizza
- `pizza_toppings` - Topping names and IDs

## Entity Relationship Diagram
![ERD](../assets/ERD-02-Pizza-Runner.svg)
...
## Relevant Links
- [Entity Relationship Diagram - dbdiagram](https://dbdiagram.io/d/5f3e085ccf48a141ff558487/?utm_source=dbdiagram_embed&utm_medium=bottom_open)

- [Case Study 2 SQL Editor - DB Fiddle](https://www.db-fiddle.com/f/7VcQKQwsS3CTkGRFG7vu98/65)